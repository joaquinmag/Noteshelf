...
<link rel="stylesheet" href="${resource(dir:'css',file:'main.css')}" />
	...
	<h3><span style="font-family: 'verdana', 'geneva';">Fecha de pr&eacute;stamo: <g:formatDate format="dd/MM/yyyy HH:mm" date="${Calendar.getInstance().getTime()}" /></span></h3>
	<h3><span style="font-family: 'verdana', 'geneva';">Fecha de devoluci&oacute;n: <g:formatDate format="dd/MM/yyyy HH:mm" date="${prestamoInstance.devolucion}" /></span></h3>
